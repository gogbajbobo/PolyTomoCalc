...
ax[0].set_ylabel('Интенсивность, у.е.')
...
plt.figure(figsize=(10, 5))
plt.plot(Mo_spec_poly_50_energies, spec_Mo_50, label='Эксперимент', linewidth='1', c=default_blue_color)
plt.plot(energies, intensities, label='Расчёт', linestyle='dashed', c=default_blue_color)
plt.xlim([5, 55])
plt.ylim([2e-5, 4e-1])
plt.yscale('log')
