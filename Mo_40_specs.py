...
# %%
plt.plot(spec_df['keV'], spec_df['nf_gauss_5']/spec_df['nf_gauss_5'].sum(), label='5 мА')
plt.plot(spec_df['keV'], spec_df['nf_gauss_10']/spec_df['nf_gauss_10'].sum(), label='10 мА')
plt.plot(spec_df['keV'], spec_df['nf_gauss_15']/spec_df['nf_gauss_15'].sum(), label='15 мА')
plt.ylim(3e-5, 0.1)
# plt.xlim(0, 50)
plt.yscale('log')
